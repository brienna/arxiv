...
class Parser(object):
    ...
    intext_citations = 0
    xml_folder = '/Volumes/BRIENNAKH 1/arxiv/xml'
    ...
    def main(self):
        ...
        xml_files = glob.glob(self.xml_folder + '/*[.xml]')
        for xf in xml_files:
...
if __name__ == '__main__':
    ...
    # Test one paper
    #fulltext = p.parse('xml/0704.0139.xml')
    #tokens = p.cleanse(fulltext)
    #print(tokens)
    
    # Parse and cleanse all papers
    p.main()
